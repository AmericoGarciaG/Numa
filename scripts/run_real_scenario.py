...
def run_scenario():
    ...
    client.post("/api/users/", json={"email": TEST_EMAIL, "password": TEST_PASSWORD, "name": "E2E User"})
    
    # Login para obtener Token
    login_response = client.post("/api/token", data={"username": TEST_EMAIL, "password": TEST_PASSWORD})
